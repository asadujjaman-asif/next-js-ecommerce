                ...
                <div className="w-full lg:w-1/2 order-2">
                    <div className="flex items-center">
                        <button className="flex text-sm text-blue-500 focus:outline-none">
                            <span className="flex items-center justify-center text-white bg-blue-500 rounded-full h-5 w-5 mr-2">1</span> Contacts
                        </button>
                        <button className="flex text-sm text-gray-700 ml-8 focus:outline-none">
                            <span className="flex items-center justify-center border-2 border-blue-500 rounded-full h-5 w-5 mr-2">2</span> Shipping
                        </button>
                        <button className="flex text-sm text-gray-500 ml-8 focus:outline-none" disabled>
                        ...
                        <div className="mt-8">
                            ...
                            <div className="mt-6 flex">
                                <label className="block w-3/12">
                                    <select className="block w-full py-2 rounded-md border-2 border-gray-400 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 mt-1">
                                        <option>NY</option>
                                        <option>DC</option>
                                        <option>MH</option>
                                        <option>MD</option>
                                ...
                                <label className="block flex-1 ml-3">
                                    <input type="text" className="block w-full py-2 rounded-md border-2 border-gray-400 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 mt-1" placeholder="Address" />
                                </label>
                            </div>
                        </div>
                        <div className="mt-8">
                            ...
                            <div className="mt-6 flex">
                                <label className="block flex-1">
                                    <input type="date" className="block w-full py-2 rounded-md border-2 border-gray-400   focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 mt-1" placeholder="Date" />
                                </label>
                            </div>
                        </div>
